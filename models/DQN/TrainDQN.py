...
from models.DQN.DQNModel import DQNNet
...
if __name__ == '__main__':
    ...
    # # 3.导出模型
    # export_model_froms(output_node_names='predictions/BiasAdd')
    #
    # # 4.获取和目标函数相关的操作名
    # gen_freeze_graph_node_name('out/', 'frozen_'+TargetModelName+'_node.txt',
    #                            output_node_names='predictions/BiasAdd')
    # # 5.获取安卓端需要的计算节点信息
    # gen_android_node_json('frozen_'+TargetModelName+'_node.txt',
    #                       TargetModelName+'_node.json',input_shape=[80, 80, 4])
    # # 6.获取去重的层输出大小
