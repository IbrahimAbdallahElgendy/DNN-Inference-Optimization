...
from models.InceptionV4.InceptionV4Model import InceptionV4Net

TargetModelName = 'InceptionV4'
...
if __name__ == '__main__':
    ...
    gen_android_node_json('frozen_'+TargetModelName+'_node.txt',
                          TargetModelName+'_node.json',input_shape=[299, 299, 3])
    # 6.获取去重的层输出大小
